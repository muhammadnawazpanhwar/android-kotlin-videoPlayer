...
import com.example.videoplayer.databinding.VideoMoreFeaturesBinding
...
class VideoAdapter(private val context: Context, private var videoList: ArrayList<Video>,
    ...
    override fun onBindViewHolder(holder: MyHolder, @SuppressLint("RecyclerView") position: Int) {
        ...
        holder.root.setOnClickListener {
            when{
                ...
                MainActivity.search -> {
                    ...
                    sendIntent(position, "SearchedVideos")
                }
                else -> {
        ...
        holder.root.setOnLongClickListener{
            ...
            bindingVMF.infoBtn.setOnClickListener {
                ...
                val bindingDV = DetailsViewBinding.bind(customDialogIF)
                ...
                bindingDV.detailTV.text  = infoText
    ...
    // for requesting write permissions on android 11 and higher devices
...
//    }
    ...
    private fun requestDeleteR(position: Int){
        ...
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.R){
            //request for delete permissions
            ...
            builder.setTitle("Delete Video/s?")
            ...
            delDialog.show()
            delDialog.getButton(androidx.appcompat.app.AlertDialog.BUTTON_POSITIVE).setTextColor(Color.RED)
            delDialog.getButton(androidx.appcompat.app.AlertDialog.BUTTON_NEGATIVE).setTextColor(Color.RED)
        }
    }
    @SuppressLint("NotifyDataSetChanged")
    ...
    private fun requestWriteR(){
        ...
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.R){
            ...
            (context as Activity).startIntentSenderForResult(pi.intentSender, 124, null,
                0, 0,0, null)
            ...
            dialogRF = MaterialAlertDialogBuilder(context).setView(customDialogRF)
                ...
                .setPositiveButton("Rename"){self,_ ->
                    ...
                    if(newName != null && currentFile.exists() && newName.toString().isNotEmpty()){
                        ...
                        val fromUri = Uri.withAppendedPath(MediaStore.Video.Media.EXTERNAL_CONTENT_URI, videoList[position].id)
                        ...
                        updateRenameUI(position, newName.toString(), newFile)
                    }
                    self.dismiss()
                }
